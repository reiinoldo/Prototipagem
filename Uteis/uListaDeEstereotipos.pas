unit uListaDeEstereotipos;

interface

uses System.UITypes, System.Classes, System.SysUtils,
     FMX.Graphics,
     uDocumentacao, uEstereotipo;
...
type
  ...
  published
    property Estereotipo : TEstereotipo read fEstereotipo write fEstereotipo;
  end;
...
begin
  Result := Format('Estereótipo %d', [Index]);
end;
